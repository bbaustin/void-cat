  ...
  /* Trees */
  {
    ...
    drama: [
      ...
      [
        ...
        "If you get hit, I don't totally understand how or why 🤔, but it'll remove points from your burned calorie score!",
        'So be careful 🥺 !!',
      ],
      [
  ...
  /* Buildings */
  {
    ...
    drama: [
      ...
      [
        ...
        "It's kind of weird 🤪, because every time this happens, things end up really similar 👯 to how they used to be.",
