...
export const STAGES: Stage[] = [
  /* Vague */
  {
    ...
    drama: [
      [
        ...
        'The orange number 🟧 is the number of calories burned.',
        ...
        "These colors on the cards match the colors of the meters at the top of the screen ☝️ , so it'll be easy for you to keep track of. It's really good design 🎨 !!",
  ...
  /* Buildings */
  {
    ...
    drama: [
      ...
      [
        "OK, I'll tell you! I'm the narrator from the 🏆 award-winning (well, 👕 t-shirt winning) game, 💖 PicoBuddy 💖 !",
        ...
        'But... ⏳ that was 72.4 billion years ago ⌛️ ...',
        "So it can't be the same you from last time...",
      ],
      [
        'These things are kind of cyclical, though.',
        'Even though we achieved nothingness ⬛️, something always seems to wriggle 🪱 its way back into existence 🎇 .',
        "It's kind of weird 🤪, because every time the universe repeats itself, things end up really similar 👯 to how they used to be.",
        "Like, there's still an Earth, it's still filled with people, they all have their routines...",
        "There's probably a parallel to draw here with the workouts!",
      ],
      [
        "Well, I guess it doesn't matter much, anyway...",
        "Because if you didn't pick up on it yet, VOID Cat is another harbinger of ⬛️ THE GREAT UNBECOMING ⬛️ !",
        ...
        'But it really stands for... Voluminous Omniscient Indestructible Death Cat!',
      ],
      [
        'Those red attack squares 🟥 are actually coordinates of intercontinental missiles.',
  ...
  /* Space */
  {
    ...
    drama: [
      [
        ...
        "It doesn't even fit in the screen correctly! Bad design!",
        ...
        "You can't actually buy anything with all the money you collected... I mean... there's nothing left to buy, anyway...",
